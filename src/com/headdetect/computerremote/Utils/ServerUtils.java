...
import com.headdetect.computerremote.Networking.packets.PacketGetInfo;
import com.headdetect.computerremote.Networking.packets.PacketSendInfo;
...
public class ServerUtils {
	...
	public static String getServerName(InetAddress s) {
		try {
			...
			Packet.QuickSend(sd, new PacketGetInfo());
			PacketSendInfo info = (PacketSendInfo) Packet.QuickRead(sd, 7);
