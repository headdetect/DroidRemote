package com.remotedroid.core.utils;
...
public class ByteConverter {
	...
	public static long[] toLongA( byte[] data ) {
		...
		for ( int i = 0; i < lngs.length; i++ ) {
			lngs[ i ] = toLong( new byte[] { data[ ( i * 8 ) ] , data[ ( i * 8 ) + 1 ] , data[ ( i * 8 ) + 2 ] , data[ ( i * 8 ) + 3 ] , data[ ( i * 8 ) + 4 ] ,
	...
	public static double[] toDoubleA( byte[] data ) {
		...
		for ( int i = 0; i < dbls.length; i++ ) {
			dbls[ i ] = toDouble( new byte[] { data[ ( i * 8 ) ] , data[ ( i * 8 ) + 1 ] , data[ ( i * 8 ) + 2 ] , data[ ( i * 8 ) + 3 ] , data[ ( i * 8 ) + 4 ] ,
					data[ ( i * 8 ) + 5 ] , data[ ( i * 8 ) + 6 ] , data[ ( i * 8 ) + 7 ] , } );
		}
		return dbls;
	}
