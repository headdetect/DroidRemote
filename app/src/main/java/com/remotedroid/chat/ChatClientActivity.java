...
import com.remotedroid.chat.ChatItem.FloatDirection;
import com.remotedroid.chat.networking.ChatClient;
...
public class ChatClientActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TCPClient.setOnConnectionListener(connectionListener);
	...
	private final ConnectionListener connectionListener = new ConnectionListener() {
		...
		@Override
		public void onJoin(TCPClient client) {
