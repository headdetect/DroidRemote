...
import me.mrlopez.droidremote.app.ComputerOptionsDialog.ComputerOptionClickedListener;
import me.mrlopez.droidremote.app.InputTextDialog.TextEnteredListener;
import me.mrlopez.droidremote.app.PowerOptionsDialog.PowerOptionsClickedListener;
import me.mrlopez.droidremote.app.networking.CommandingClient;
import me.mrlopez.droidremote.app.networking.PacketBeep;
import me.mrlopez.droidremote.app.networking.PacketCommand;
import me.mrlopez.droidremote.chat.ChatClientActivity;
import me.mrlopez.droidremote.core.Packet;
import me.mrlopez.droidremote.core.utils.Computer;
import me.mrlopez.droidremote.core.utils.ServerUtils;
import me.mrlopez.droidremote.core.utils.ServerUtils.DiscoverComputers;
import me.mrlopez.droidremote.mousepad.MousePadActivity;
import me.mrlopez.droidremote.tv.TVActivity;
...
public class SelectComputerActivity extends FragmentActivity implements ComputerOptionClickedListener, PowerOptionsClickedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itmManual:
                ...
                InputTextDialog dialog = InputTextDialog.newInstance(this, "Enter Address", new TextEnteredListener() {
                    @Override
                ...
                dialog.show(this.getSupportFragmentManager(), "TextInputAddress");
                return true;
    ...
    public void onComputerOptionClicked(int index, Computer comp) {
        if (index == 0) {
            ...
            DialogFragment dialog = InputTextDialog.newInstance(this, "Enter Command", new TextEnteredListener() {
                @Override
                public void onTextReceived(String result) {
    ...
    public void connectToIp(final String txt) {
     ...
     * Connect to the specified computer
     */
    public void connectForMouse(Computer comp) {
        ...
        try {
            ...
            Intent sillyIntent = new Intent(SelectComputerActivity.this, MousePadActivity.class);
            sillyIntent.putExtra("IP", comp.getIp().toString());
            startActivity(sillyIntent);
    ...
    private class ComputerList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            //TODO: ServerUtils.getComputersOnNetwork(mWifi);
    ...
    private class RunCommand extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                ...
                dialog.show(SelectComputerActivity.this.getFragmentManager(), "TextDialog");
            }
